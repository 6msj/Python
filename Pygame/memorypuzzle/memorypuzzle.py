...
REVEALSPEED = 8 # speed boxes' sliding reveals and coveres
    ...
    while True: # main game loop
        ...
        if boxx != None and boxy != None:
            ...
            if not revealedBoxes[boxx][boxy] and mouseClicked:
                ...
                if firstSelection == None: #the current box was clicked
...
def splitIntoGroupsOf(groupSize, theList):
    # splits a list into a list of lists, where the inner lists have at the most groupSize of items
    result = []
